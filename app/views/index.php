<?php define('CSS_PATH', 'http://localhost/elibrary/css/'); ?> 
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="http://localhost/elibrary/css/index.css">
          ...
          <p>  تصفح حسب القسم</p>
           <div class="container-catigroy-box">
              <div class="catigroy-box">
                <a href="catigory"> <img src="images/svgexport-46.svg"></a>
                <p>دين</p>
              </div>

              <div class="catigroy-box">
                 <a href="category/.php"> <img src="images/svgexport-42.svg"></a>
                  <p>تاريخ</p>
              </div>
